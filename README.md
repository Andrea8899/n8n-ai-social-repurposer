...
3. **Elaborazione Locale (LM Studio):** I dati vengono inviati all'endpoint locale. Gemma elabora il testo seguendo delle regole di copywriting precise (il gancio, la divisione in paragrafi, il tono di voce).
